...
public class Scenario_BLEScan_Connect_Discovery_RealtimeDataByUI_DisconnectionByApp extends Scenario {
    private BluetoothLE bluetoothLE;

    public Scenario_BLEScan_Connect_Discovery_RealtimeDataByUI_DisconnectionByApp(BluetoothLE bluetoothLE, ArrayList<BLEState> path) {
        super(path);
